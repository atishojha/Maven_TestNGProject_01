...
public Xls_Reader(String path) {
	 ...
	 //atish XSSFHyperlink link = createHelper.createHyperlink(XSSFHyperlink.LINK_FILE);
		    Hyperlink link = createHelper.createHyperlink(HyperlinkType.FILE);
		    link.setAddress(url);
	 //atish cell.setHyperlink(link);
     ...
     //atish style.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
		...
		public boolean removeColumn(String sheetName, int colNum) {
			...
			style.setFillForegroundColor(HSSFColor.GREY_40_PERCENT.index);
			XSSFCreationHelper createHelper = workbook.getCreationHelper();
	//atish	style.setFillPattern(HSSFCellStyle.NO_FILL);
